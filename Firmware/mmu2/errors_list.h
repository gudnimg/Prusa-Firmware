...
typedef enum : uint16_t {
    NO_FAILURE = 0, // OK, FILAMENT EJECT, FILAMENT CHANGE etc.
    MECHANICAL_FAILURE,
    TEMPERATURE_FAILURE,
    ELECTRICAL_FAILURE,
    CONNECT_FAILURE,
...
static const constexpr uint16_t errorType[] PROGMEM = {
    MECHANICAL_FAILURE, // ERR_MECHANICAL_FINDA_DIDNT_TRIGGER,
    MECHANICAL_FAILURE, // ERR_MECHANICAL_FINDA_DIDNT_GO_OFF,
    MECHANICAL_FAILURE, // ERR_MECHANICAL_FSENSOR_DIDNT_TRIGGER,
    MECHANICAL_FAILURE, // ERR_MECHANICAL_FSENSOR_DIDNT_GO_OFF,
    MECHANICAL_FAILURE, // ERR_MECHANICAL_PULLEY_CANNOT_MOVE,
    MECHANICAL_FAILURE, // ERR_MECHANICAL_FSENSOR_TOO_EARLY,
    MECHANICAL_FAILURE, // ERR_MECHANICAL_INSPECT_FINDA,
    MECHANICAL_FAILURE, // ERR_MECHANICAL_LOAD_TO_EXTRUDER_FAILED,
    MECHANICAL_FAILURE, // ERR_MECHANICAL_SELECTOR_CANNOT_HOME,
    MECHANICAL_FAILURE, // ERR_MECHANICAL_SELECTOR_CANNOT_MOVE,
    MECHANICAL_FAILURE, // ERR_MECHANICAL_IDLER_CANNOT_HOME,
    MECHANICAL_FAILURE, // ERR_MECHANICAL_IDLER_CANNOT_MOVE,
    TEMPERATURE_FAILURE, // ERR_TEMPERATURE_PULLEY_WARNING_TMC_TOO_HOT,
    TEMPERATURE_FAILURE, // ERR_TEMPERATURE_SELECTOR_WARNING_TMC_TOO_HOT,
    TEMPERATURE_FAILURE, // ERR_TEMPERATURE_IDLER_WARNING_TMC_TOO_HOT,
    TEMPERATURE_FAILURE, // ERR_TEMPERATURE_PULLEY_TMC_OVERHEAT_ERROR,
    TEMPERATURE_FAILURE, // ERR_TEMPERATURE_SELECTOR_TMC_OVERHEAT_ERROR,
    TEMPERATURE_FAILURE, // ERR_TEMPERATURE_IDLER_TMC_OVERHEAT_ERROR,
    ELECTRICAL_FAILURE, // ERR_ELECTRICAL_PULLEY_TMC_DRIVER_ERROR,
    ELECTRICAL_FAILURE, // ERR_ELECTRICAL_SELECTOR_TMC_DRIVER_ERROR,
    ELECTRICAL_FAILURE, // ERR_ELECTRICAL_IDLER_TMC_DRIVER_ERROR,
    ELECTRICAL_FAILURE, // ERR_ELECTRICAL_PULLEY_TMC_DRIVER_RESET,
    ELECTRICAL_FAILURE, // ERR_ELECTRICAL_SELECTOR_TMC_DRIVER_RESET,
    ELECTRICAL_FAILURE, // ERR_ELECTRICAL_IDLER_TMC_DRIVER_RESET,
    ELECTRICAL_FAILURE, // ERR_ELECTRICAL_PULLEY_TMC_UNDERVOLTAGE_ERROR,
    ELECTRICAL_FAILURE, // ERR_ELECTRICAL_SELECTOR_TMC_UNDERVOLTAGE_ERROR,
    ELECTRICAL_FAILURE, // ERR_ELECTRICAL_IDLER_TMC_UNDERVOLTAGE_ERROR,
    ELECTRICAL_FAILURE, // ERR_ELECTRICAL_PULLEY_TMC_DRIVER_SHORTED,
    ELECTRICAL_FAILURE, // ERR_ELECTRICAL_SELECTOR_TMC_DRIVER_SHORTED,
    ELECTRICAL_FAILURE, // ERR_ELECTRICAL_IDLER_TMC_DRIVER_SHORTED,
    ELECTRICAL_FAILURE, // ERR_ELECTRICAL_PULLEY_SELFTEST_FAILED,
    ELECTRICAL_FAILURE, // ERR_ELECTRICAL_SELECTOR_SELFTEST_FAILED,
    ELECTRICAL_FAILURE, // ERR_ELECTRICAL_IDLER_SELFTEST_FAILED,
    ELECTRICAL_FAILURE, // ERR_ELECTRICAL_MCU_UNDERVOLTAGE_VCC,
    CONNECT_FAILURE, // ERR_CONNECT_MMU_NOT_RESPONDING,
    CONNECT_FAILURE, // ERR_CONNECT_COMMUNICATION_ERROR,
    SYSTEM_FAILURE, // ERR_SYSTEM_FILAMENT_ALREADY_LOADED, 
    SYSTEM_FAILURE, // ERR_SYSTEM_INVALID_TOOL, 
    SYSTEM_FAILURE, // ERR_SYSTEM_QUEUE_FULL, 
    SYSTEM_FAILURE, // ERR_SYSTEM_FW_UPDATE_NEEDED, 
    SYSTEM_FAILURE, // ERR_SYSTEM_FW_RUNTIME_ERROR,
    SYSTEM_FAILURE, // ERR_SYSTEM_UNLOAD_MANUALLY,
    NO_FAILURE // ERR_SYSTEM_FILAMENT_EJECTED,
};
